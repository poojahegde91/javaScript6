## Seed code -Boilerplate for Assignment 6 - Data Munging Assignment(PLEASE CHANGE THIS README POST CLONNING - SAVE THE INSTRUCTIONS SEPERATELY)

###Problem Statement
Access the stored data from objects and manipulate these object

###Expected solution
Read the CSV content and create array of objects for the data. Print object data and manipulated object data on console.
...
8. Use Array methods such as map() and sort() to create ascending and descending data.
